from coralillo import Model, Form, BoundedModel, fields
...
class Pet(Model):
    name = fields.Text()
    owner = fields.ForeignIdRelation(
        'coralillo.tests.models.Person', inverse='pets'
    )
...
class Employee(Model):
    ...
    office = fields.ForeignIdRelation(
        'coralillo.tests.models.Office', inverse='employees'
    )
